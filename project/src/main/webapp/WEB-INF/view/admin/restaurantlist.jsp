			...
			<div>
				<table class="w3-table-all">
					...
					<c:forEach var="rest" items="${restList}">
						...
						<tr>
							<td><a
								href="../restaurant/restaurantInfo?num=${rest.restNum}">${rest.restNum}</a>
							</td>
							<td><a
								href="../restaurant/restaurantInfo?num=${rest.restNum}">${rest.name}</a>
							</td>
							<td>${rest.userId}</td>
					...
					<tr>
						<td colspan="5" class="w3-center"><c:if test="${pageNum > 1}">
